...
<head>
    ...
    <title>SIMTA - Sistem Manajemen Tugas Akhir</title>
    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo"><span class="logoclass">SIMTA</span> </a>
                <a href="index.html" class="logo logo-small logoclass">SIMTA
                </a>
            </div>
            <a href="javascript:void(0);" id="toggle_btn"> <i class="fe fe-text-align-left text-white"></i> </a>
            <a class="mobile_btn" id="mobile_btn"> <i class="fas fa-bars text-white"></i> </a>
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img
                                class="rounded-circle" src="<?php echo base_url(); ?>/assets/img/profiles/avatar-01.jpg"
                                width="31" alt="Soeng Souy"></span> </a>
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm"> <img
                                    src="<?php echo base_url(); ?>/assets/img/profiles/avatar-01.jpg" alt="User Image"
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12 mt-5">
                            ...
                            <p><?= password_hash('admin',PASSWORD_BCRYPT);?></p>
                            <ul class="breadcrumb">
